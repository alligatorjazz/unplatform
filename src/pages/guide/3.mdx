...
<DatabaseView client:load title={"RSS Readers"} className="mb-4" hideOptions={{city: true, category: true, requireRSS: true, requireNewsletter: true}} defaultOptions={{category: "reader"}}/>
