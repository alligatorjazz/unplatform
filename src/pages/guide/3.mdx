...
- A website distributes a file (usually at a link like `https://website.com/rss.xml`) that contains the content of their "RSS feed" - essentially just a chronological list of posts on the site.
