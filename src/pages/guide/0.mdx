...
First, there's one thing we need to get out of the way.
...
<a href="1" class={"mx-auto block p-4 py-2 bg-accentColor text-bgColor prompt w-min whitespace-nowrap"}>{">: Sounds good."} </a>